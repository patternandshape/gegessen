        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent() {
                    this.foods = [
                        new food_model_1.Food("Apfelstrudel", "Grandma sent this via FedEx. Only ate one 'serving'.", 78),
                        new food_model_1.Food("Sauerkraut", "Put a bit on top of my vegan bratwurst.", 27),
                        new food_model_1.Food("Marzipankartoffeln", "Ate too many of these at the Christmas market. Sehr gut.", 165)
                    ];
                }
